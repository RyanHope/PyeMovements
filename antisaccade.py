...
def get_args(args=sys.argv[1:]):
	...
	parser.add_argument("--labile_stdev", type=int, action="store", default=5)
	parser.add_argument("--nonlabile_mean", type=float, action="store", default=.040)
	parser.add_argument("--nonlabile_stdev", type=int, action="store", default=5)
	parser.add_argument("--exec_mean", type=float, action="store", default=.040)
	parser.add_argument("--exec_stdev", type=int, action="store", default=5)
	parser.add_argument("--attn_mean", type=float, action="store", default=.180)
	parser.add_argument("--attn_stdev", type=int, action="store", default=5)
